...
CREATE TABLE `suscripciones` (
  ...
  CONSTRAINT `canal` FOREIGN KEY (`idcanal`) REFERENCES `canal` (`idcanal`),
  CONSTRAINT `usuarios` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`idUsuario`)
...
INSERT INTO `suscripciones` VALUES (2,10),(3,10),(1,20),(1,30),(2,30);
